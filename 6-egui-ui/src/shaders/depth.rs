...
pub mod bind_groups {
    ...
    pub struct BindGroupLayout0<'a> {
        pub t_depth: &'a wgpu::TextureView,
        pub s_depth: &'a wgpu::Sampler,
        ...
        pub fn from_bindings(device: &wgpu::Device, bindings: BindGroupLayout0) -> Self {
            ...
            let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
                ...
                entries: &[
                    wgpu::BindGroupEntry {
                        binding: 0,
                        resource: wgpu::BindingResource::TextureView(bindings.t_depth),
                    },
                    wgpu::BindGroupEntry {
                        binding: 1,
                        resource: wgpu::BindingResource::Sampler(bindings.s_depth),
                    },
                    wgpu::BindGroupEntry {
                        binding: 2,
...
pub const SOURCE: &str = include_str!("depth.wgsl");
